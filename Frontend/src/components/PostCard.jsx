...
function PostCard({ slug, title, featuredImage, category, subTitle }) {
  // console.log("🪵 PostCard received:", { slug, title, featuredImage }); // make sure slug is there
  
  return (
    <Link to={`/post/${slug}`}>
      <div className='w-full bg-gray-100 rounded-xl p-4 cursor-pointer hover:shadow-primay/20 transition-shadow duration-300 space-y-3'>
